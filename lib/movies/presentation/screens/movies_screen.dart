...
import 'package:movies_clean_code/movies/presentation/components/components.dart';
...
class MainMoviesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<HomePageBloc>()..add(GetNowPlayingMoviesEvent()),
      child: Scaffold(
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              nowPlayingCarousalSliderWidget(),
              Container(
