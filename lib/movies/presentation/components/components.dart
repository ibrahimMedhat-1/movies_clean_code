...
Widget popularListViewWidget() => BlocBuilder<HomePageBloc, HomePageState>(
      buildWhen: (previous, current) => previous.popularState != current.popularState,
      builder: (context, state) {
        print('popular bloc ${state.popularState}');
...
Widget topRatedListViewWidget() => BlocBuilder<HomePageBloc, HomePageState>(
      buildWhen: (previous, current) => previous.topRatedState != current.topRatedState,
      builder: (context, state) {
        print('top rated bloc ${state.topRatedState}');
